...
try:
    ...
    cursor.execute("""--sql INSERT INTO tipo_usuarios (nombre_tipo, descripcion_tipo) VALUES
                    ('Administrador', 'Acceso completo al sistema'),
                    ('Cliente', 'Usuario con acceso restringido'),
                    ('Moderador', 'Puede revisar y aprobar contenido');""")

    # -- Poblar tabla usuarios
    cursor.execute("""--sql INSERT INTO usuarios (username, password, email, id_tipo_usuario) VALUES
    ...
    # -- Poblar tabla ciudad
    cursor.execute("""--sql INSERT INTO ciudad (nombre_ciudad, region) VALUES
    ...
    cursor.execute("""--sql INSERT INTO personas (rut, nombre_completo, fecha_nac, id_usuario, id_ciudad) VALUES
